...
- Matching is case-insensitive for package IDs and supports matching any version via `"*"`. `DesiredNuGetPackage` implements equality against both another desired package and `ICatalogLeafItem`, which is why matching logic stays compact.
